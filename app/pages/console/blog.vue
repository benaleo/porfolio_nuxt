    ...
    <div class="grid gap-6 lg:grid-cols-[1fr_420px]">
      ...
      <div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 overflow-x-auto">
        <table class="min-w-full text-sm">
          ...
          <tbody>
            <tr v-for="p in posts || []" :key="p.id" class="border-b border-slate-200/70 dark:border-slate-800">
              ...
              <td class="px-4 py-2">
                <div class="flex items-center gap-2">
                  <button class="px-2 py-1 rounded border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800" @click="startEdit(p)">Edit</button>
                  <button class="px-2 py-1 rounded border border-red-300 text-red-700 hover:bg-red-50" @click="onDelete(p)">Delete</button>
                </div>
              </td>
            </tr>
