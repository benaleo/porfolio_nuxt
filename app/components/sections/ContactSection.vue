  ...
  <section class="py-20" id="contact">
    <div class="mx-auto max-w-3xl px-4">
      ...
      <form class="mt-8 space-y-4" @submit.prevent="submit">
        <div class="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="name" type="text" required class="mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <label class="block text-sm text-slate-500">Email</label>
            <input v-model="email" type="email" required class="mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
        <div>
          <label class="block text-sm text-slate-500">Message</label>
          <textarea v-model="message" rows="4" required class="mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500"></textarea>
        </div>
      ...
      <div class="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm text-slate-600 dark:text-slate-300">
        <a href="tel:6281383925458" class="inline-flex items-center gap-2 hover:text-blue-600">
        ...
        <a href="https://api.whatsapp.com/send?phone=6281383925458" target="_blank" rel="noopener" class="inline-flex items-center gap-2 hover:text-green-600">
